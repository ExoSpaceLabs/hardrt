...
- Run ID: `20260903T153726Z_93522716`
- UTC start: `2026-09-03T15:37:29+00:00`
- Local start: `2026-09-03T17:37:29+02:00`
- Tester: `dev`
- Board: `NUCLEO-H755ZI-Q`
- MCU/board revision: `not recorded`
- Core under test: `CM7`
- HardRT branch: `develop`
- HardRT SHA: `935227161c57ce564739792fbc83e3bec059c49d`
...
D  validation/stm32/20260903T143930Z_28f350d0/SOURCE_BUNDLE.sha256
D  validation/stm32/20260903T143930Z_28f350d0/qualification.md
D  validation/stm32/20260903T143930Z_28f350d0/raw/preemption_priority_gdb.log
D  validation/stm32/20260903T143930Z_28f350d0/raw/preemption_priority_rr_gdb.log
D  validation/stm32/20260903T143930Z_28f350d0/raw/timing_event_to_task_gdb.log
D  validation/stm32/20260903T143930Z_28f350d0/raw/timing_sem_isr_ready_gdb.log
D  validation/stm32/20260903T145719Z_28f350d0/qualification.md
```
...
| DWT event_to_task timing | **PASS** | Build/flash succeeds; timing_target_reached is observed; no kernel/example error; count equals 10000; min <= avg <= max; SystemCoreClock and TIM2 PSC/ARR are recorded. | `raw/timing_event_to_task_*.log` | count=10000, min=1692 cycles, avg=1757 cycles, max=2673 cycles. |
| DWT sem_isr_ready timing | **PASS** | Build/flash succeeds; timing_target_reached is observed; no kernel/example error; count equals 10000; min <= avg <= max; SystemCoreClock and TIM2 PSC/ARR are recorded. | `raw/timing_sem_isr_ready_*.log` | count=10000, min=284 cycles, avg=294 cycles, max=307 cycles. |
| DWT ready_to_task timing | **PASS** | Build/flash succeeds; timing_target_reached is observed; no kernel/example error; count equals 10000; min <= avg <= max; SystemCoreClock and TIM2 PSC/ARR are recorded. | `raw/timing_ready_to_task_*.log` | count=10000, min=1238 cycles, avg=1389 cycles, max=2353 cycles. |
...
- UTC end: `2026-09-03T15:40:12+00:00`
- Local end: `2026-09-03T17:40:12+02:00`

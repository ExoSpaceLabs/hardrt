...
cmake -DHARDRT_PORT=posix -DHARDRT_ENABLE_CPP=ON -DHARDRT_BUILD_EXAMPLES=ON -DHARDRT_BUILD_TESTS=ON -DHARDRT_STRICT=ON -DHARDRT_SANITIZE=ON -DHARDRT_DEBUG=OFF ..

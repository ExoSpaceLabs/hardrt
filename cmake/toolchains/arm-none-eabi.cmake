...
# Preserve the optional C++ selection in compiler checks/try_compile projects.
list(APPEND CMAKE_TRY_COMPILE_PLATFORM_VARIABLES HARDRT_ENABLE_CPP)
...
if(NOT ARM_NONE_EABI_GCC)
  message(FATAL_ERROR "arm-none-eabi-gcc not found. Install the ARM GCC toolchain.")
endif()

set(CMAKE_C_COMPILER ${ARM_NONE_EABI_GCC})

# A C-only HardRT build must not depend on arm-none-eabi-g++. The cache option
# is available to the toolchain before project() when passed with -D, and on
# reconfigure it is restored from CMakeCache.txt.
if(HARDRT_ENABLE_CPP)
  find_program(ARM_NONE_EABI_GPP arm-none-eabi-g++)
  if(NOT ARM_NONE_EABI_GPP)
    message(FATAL_ERROR
      "HARDRT_ENABLE_CPP=ON requires arm-none-eabi-g++, but it was not found.")
  endif()
...
# Cortex-M assembly is compiled through GCC so preprocessing remains available.

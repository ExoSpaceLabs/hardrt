...
- **MIT Licensed** — free to use, hack, and ship anywhere.
...
You can start from:
- `port/null/port_null.c` → bare stubs
- `port/posix/` → Linux desktop simulation (next planned)
- `port/cortex_m/` → real ARM Cortex-M (later)

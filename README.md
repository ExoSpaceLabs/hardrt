...
**HardRT** — the heartbeat of small embedded systems.  
...
|:--|:--|:--|
| `HARDRT_ENABLE_CPP` | `OFF` | Build C++ wrappers (header-only interface target) |
| `HARDRT_BUILD_EXAMPLES` | `ON` | Build examples |
| `HARDRT_BUILD_TESTS` | `ON` | Build test suite (POSIX port) |

...
static void long_sleeper(void* arg){ (void)arg; for(;;){ hrt_sleep(50); } }
...
const test_case_t* get_tests_idle_behavior(int* out_count){ if(out_count)*out_count=(int)(sizeof(CASES)/sizeof(CASES[0])); return CASES; }
